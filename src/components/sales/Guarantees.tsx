...
const guarantees = [
  ...
  { icon: RefreshCw, title: "Garantia de 30 dias", desc: "Satisfação garantida ou dinheiro de volta" },
  { icon: Award, title: "Vegano e Zero Açúcar", desc: "Fórmula natural de máxima qualidade" },
];
