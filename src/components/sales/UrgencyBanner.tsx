  ...
  <section className="container py-8">
    <div className="bg-purple-50 border border-purple-200 rounded-2xl p-6 text-center">
      <div className="flex items-center justify-center gap-2 mb-2">
        ...
        <h3 className="font-extrabold text-foreground text-center">ATENÇÃO: Estoque quase esgotado!</h3>
      </div>
      <p className="text-sm text-muted-foreground mb-4">
        Restam apenas <strong className="text-foreground">15 unidades</strong> com preço promocional. Depois, volta ao preço original.
      </p>
      <a href="#pricing-kits" onClick={(e) => { e.preventDefault(); document.getElementById('kit-destaque')?.scrollIntoView({ behavior: 'smooth' }); }}
        ...
        <Moon className="w-5 h-5" />Oferta por Tempo Limitado
      </a>
    </div>
  </section>
);
