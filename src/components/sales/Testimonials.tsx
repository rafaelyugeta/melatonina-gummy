...
import feedbackImg1 from "@/assets/feedback-1.png";
import feedbackImg2 from "@/assets/feedback-2.png";
import feedbackImg3 from "@/assets/feedback-3.png";
import feedbackImg4 from "@/assets/feedback-4.png";
  ...
  <section className="bg-[#1a1a2e] py-10">
    <div className="container">
      ...
      <div className="flex items-center justify-center gap-2 mb-6">
        ...
        <span className="text-xs text-gray-400">1.847+ clientes satisfeitas</span>
      </div>
