  ...
  return (
    <section className="bg-background py-10">
      <div className="container text-center">
        <h2 className="text-xl font-extrabold text-foreground mb-1">Não deixe seu sono para depois</h2>
        <p className="text-muted-foreground text-sm mb-4">Garanta agora sua Melatonina em Gummy e tenha noites tranquilas</p>
        ...
        <div className="flex items-center justify-center gap-2 text-muted-foreground text-xs">
          <ShieldCheck className="w-4 h-4" />Pagamento 100% seguro · Seus dados estão protegidos
        </div>
      </div>
    </section>
  );
