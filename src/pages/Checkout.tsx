...
const kitMap: Record<string, { title: string; price: number; originalPrice: number; image: string; productId: string; quantity: number }> = {
  ...
  "2": { title: "2 Melatonina Gummy", price: 64.90, originalPrice: 109.90, image: kitImg2, productId: "a1c371a8-8da5-4df7-82a7-e538a97376c6", quantity: 1 },
  "3": { title: "3 Melatonina Gummy + Brinde", price: 84.90, originalPrice: 164.70, image: kitImg3, productId: "a1c37256-f94d-4da9-a915-6f81eacb7163", quantity: 1 },
};
...
const Checkout = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (!qrCodeText) throw new Error(message || "Código Pix não retornado. Tente novamente.");
  ...
  // Polling de status (5 em 5 segundos)
  useEffect(() => {
    ...
    return (
      <div className="min-h-screen bg-[#f0f2f5] max-w-[768px] mx-auto flex items-center justify-center">
        <div className="text-center p-8">
          <Loader2 className="w-12 h-12 text-[#00bcd4] animate-spin mx-auto mb-4" />
      ...
      <div className="min-h-screen bg-[#f0f2f5] max-w-[768px] mx-auto">
        ...
        <div className="mx-4 mb-4 bg-white rounded-xl p-5 shadow-sm border border-gray-100">
          <div className="flex items-center gap-2 mb-4">
            <span className="w-6 h-6 bg-[#00bcd4] text-white rounded-full flex items-center justify-center text-xs font-bold">
          ...
          <div className="mb-4">
            ...
            <div className="flex gap-2">
              ...
              <button onClick={handleCopy} className="px-4 py-2.5 bg-[#00bcd4] text-white text-xs font-bold rounded-lg hover:bg-[#00a5bb] transition-colors whitespace-nowrap flex items-center gap-1">
          ...
          {/* Instruções */}
          <div className="bg-[#00bcd4]/5 rounded-xl p-4 mb-4">
            <p className="font-bold text-gray-800 text-sm mb-2">Como pagar com PIX:</p>
            <ol className="text-xs text-gray-600 space-y-1.5 list-decimal list-inside">
              <li>Abra o app do seu banco</li>
              <li>Procure a opção PIX ou escanear QR Code</li>
          ...
          <div className="flex items-center justify-center gap-2 mt-4">
            ...
            <span className="text-[#00bcd4] font-bold text-lg">{formatBRL(kit.price)}</span>
          </div>
        </div>
    ...
    return (
      <div className="min-h-screen bg-[#f0f2f5] max-w-[768px] mx-auto flex items-center justify-center">
        <div className="mx-4 bg-white rounded-xl p-8 shadow-sm border border-gray-100 text-center w-full">
          ...
          <p className="text-sm text-gray-500 mb-6">Você receberá os detalhes por e-mail em breve.</p>
          ...
          <button onClick={() => navigate("/")} className="w-full bg-[#00bcd4] hover:bg-[#00a5bb] text-white font-bold py-3.5 rounded-xl transition-colors text-sm">
            Voltar ao início
          </button>
        </div>
      </div>
    ...
    return (
      <div className="min-h-screen bg-[#f0f2f5] max-w-[768px] mx-auto flex items-center justify-center">
        <div className="mx-4 bg-white rounded-xl p-8 shadow-sm border border-gray-100 text-center w-full">
          ...
          <button onClick={() => setStep("form")} className="w-full bg-[#00bcd4] hover:bg-[#00a5bb] text-white font-bold py-3.5 rounded-xl transition-colors text-sm">
            Tentar novamente
          </button>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-[#f0f2f5] max-w-[768px] mx-auto">
      ...
      <div className="mx-4 mb-4 bg-white rounded-xl p-4 shadow-sm border border-gray-100">
        ...
        <div className="flex items-center gap-3">
          <img src={kit.image} alt={kit.title} className="w-12 h-12 rounded-lg object-cover" />
          <div>
      ...
      <div className="mx-4 mb-4 bg-white rounded-xl p-5 shadow-sm border border-gray-100">
        ...
        <button onClick={handleSubmit} className="w-full bg-[#00bcd4] hover:bg-[#00a5bb] text-white font-bold py-4 rounded-xl transition-colors text-sm shadow-lg">
          Gerar Pix
        </button>
